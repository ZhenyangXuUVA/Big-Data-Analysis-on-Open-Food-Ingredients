...
"""By removing all of the remaining NaN values, we have enhanced the quality and integrity of our dataset. Likewise, the shape of our dataframe has changed from (356027, 163) to (170551, 19). This reduction in both the number of rows and columns highlights the effectiveness of our data cleaning process. We removed irrelevant columns and addressed missing values, resulting in a streamlined and focused dataset that is more suited for our analysis."""
